...
<div class="container-max-md">
        ...
        <div class="list-group list-group-flush mb-3">
            {#each allRoles as role (role.id)}
                ...
                {@const status = assignment
                    ...
                    : null}
                <div
                    class="list-group-item d-flex align-items-center justify-content-between {isExpired
                        ? 'opacity-75'
                        : ''}"
                >
                    <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="d-flex gap-2">
                        {#if isActive && activeAssignment}
                              <Button
                                  ...
                                  color="link"
                                  on:click={() =>
                                      openExpiryModal(activeAssignment)}
                              >
                                  <Fa icon={faWrench} />
                              </Button>
                              <Tooltip
    ...
    <AsyncButton
        ...
        class="ms-auto"
        click={update}
        disabled={!$adminPermissions.usersEdit}>Update</AsyncButton
    >
    ...
    <AsyncButton
        ...
        color="danger"
        click={remove}
        disabled={!$adminPermissions.usersDelete}>Remove</AsyncButton
    >
    </div>
</div>
