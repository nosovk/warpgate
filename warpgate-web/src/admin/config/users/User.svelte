...
<div class="container-max-md">
  <Loadable promise={initPromise}>
    {#if user}
      ...
      {#if adminPermissions.value.usersEdit && user.credentialPolicy}
        <CredentialEditor
          userId={user.id}
  ...
  <div class="d-flex">
    ...
    <AsyncButton
      ...
      class="ms-auto"
      click={update}
      disabled={!adminPermissions.value.usersEdit}>Update</AsyncButton
    >
    ...
    <AsyncButton
      ...
      color="danger"
      click={remove}
      disabled={!adminPermissions.value.usersDelete}>Remove</AsyncButton
    >
  </div>
</div>
